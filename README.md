...
- Lets you choose the local photo root with a macOS folder picker. If it is empty, the app previews and creates full-name tip folders and copies the loaded tree file into that root after confirmation.
